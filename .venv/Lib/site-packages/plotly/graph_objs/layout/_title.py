...
class Title(_BaseLayoutHierarchyType):
    ...
    def automargin(self):
        ...
        ensure that the title doesnâ€™t overlap with the edges of the
        container. If `yref='container'` then the margins will ensure
        that the title doesnâ€™t overlap with the plot area, tick labels,
    ...
    def _prop_descriptions(self):
        ...
        automargin
            ...
            expand to ensure that the title doesnâ€™t overlap with
            the edges of the container. If `yref='container'` then
            the margins will ensure that the title doesnâ€™t overlap
