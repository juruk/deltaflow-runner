...
class SchemeLexer(RegexLexer):
    ...
    tokens = {
        ...
        'value': [
            ...
            (r"#\\([()/'\"._!Â§$%& ?=+-]|[a-zA-Z0-9]+)", String.Char, "#pop"),
...
class RacketLexer(RegexLexer):
    ...
    _builtins = (
        ...
        'new-âˆ€/c', 'new-âˆƒ/c', 'newline', 'ninth', 'non-empty-listof',
...
class FennelLexer(RegexLexer):
    ...
    declarations = (
        'fn', 'global', 'lambda', 'local', 'macro', 'macros', 'var', 'Î»'
    )
