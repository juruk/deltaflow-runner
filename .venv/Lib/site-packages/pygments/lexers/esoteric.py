...
class AheuiLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ('['
             'ë‚˜-ë‚³ëƒ-ëƒ«ë„ˆ-ë„£ë…€-ë…›ë…¸-ë†“ë‡¨-ëˆŸë‰´-ë‹‡'
             'ë‹¤-ë‹¿ëŒœ-ëŒ·ë”-ë¯ëŽŒ-ëŽ§ë„-ëŸë´-ë‘«ë“€-ë”“'
             'ë”°-ë•‹ë•¨-ë–ƒë– -ë–»ë—˜-ë—³ë˜-ë˜«ëš€-ëš·ëœŒ-ëŸ'
             'ë¼-ëž—ëž´-ëŸëŸ¬-ë ‡ë ¤-ë ¿ë¡œ-ë¡·ë£Œ-ë¤ƒë¥˜-ë¦«'
             'ë§ˆ-ë§£ë¨€-ë¨›ë¨¸-ë©“ë©°-ëª‹ëª¨-ë«ƒë¬˜-ë­ë®¤-ë¯·'
             'ë°”-ë°¯ë±Œ-ë±§ë²„-ë²Ÿë²¼-ë³—ë³´-ë´ëµ¤-ë¶›ë·°-ë¹ƒ'
             'ë¹ -ë¹»ëº˜-ëº³ë»-ë»«ë¼ˆ-ë¼£ë½€-ë½›ë¾°-ë¿§ì€¼-ì‚'
             'ì‚¬-ìƒ‡ìƒ¤-ìƒ¿ì„œ-ì„·ì…”-ì…¯ì†Œ-ì†§ì‡¼-ìˆ³ìŠˆ-ì‹›'
             'ì‹¸-ìŒ“ìŒ°-ì‹ì¨-ìŽƒìŽ -ìŽ»ì˜-ì³ì‘ˆ-ì‘¿ì“”-ì”§'
             'ìž-ìž«ìŸˆ-ìŸ£ì €-ì ›ì ¸-ì¡“ì¡°-ì¢‹ì£ -ì¤—ì¥¬-ì¦¿'
             'ì°¨-ì±ƒì± -ì±»ì²˜-ì²³ì³-ì³«ì´ˆ-ì´£ìµ¸-ì¶¯ì¸„-ì¹—'
             'ì¹´-ìºìº¬-ì»‡ì»¤-ì»¿ì¼œ-ì¼·ì½”-ì½¯ì¿„-ì¿»í-í‚£'
             'íƒ€-íƒ›íƒ¸-í„“í„°-í…‹í…¨-í†ƒí† -í†»íˆ-í‰‡íŠœ-í‹¯'
             'íŒŒ-íŒ§í„-íŸí¼-íŽ—íŽ´-íí¬-í‡í‘œ-í’“í“¨-í”»'
             'í•˜-í•³í–-í–«í—ˆ-í—£í˜€-í˜›í˜¸-í™“íš¨-í›Ÿíœ´-íž‡'
             ']', Operator),
            ('.', Comment),
        ],
    }
